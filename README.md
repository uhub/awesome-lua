...
* [chenxuuu/llcom](https://github.com/chenxuuu/llcom) - 可运行lua的串口调试助手Serial debugger, with lua scripts.
...
* [freeioe/freeioe](https://github.com/freeioe/freeioe) - FreeIOE is a framework for building IOE (Internet Of Everything) gateway
...
* [TerraME/terrame](https://github.com/TerraME/terrame) - TerraME is a programming environment for spatial dynamical modelling
...
* [pmusa/lmprof](https://github.com/pmusa/lmprof) - Lua Memory Profiler (lmprof)
* [osyrisrblx/t](https://github.com/osyrisrblx/t) - A Runtime Typechecker for Roblox
* [openresty/luajit2-test-suite](https://github.com/openresty/luajit2-test-suite) - OpenResty's LuaJIT test suite based on Mike Pall's LuaJIT tests
...
* [mwSora/payday-2-luajit](https://github.com/mwSora/payday-2-luajit) - Decompiled Lua of PAYDAY 2. Other repo with lines number
...
* [L-B-X/LBXStripper](https://github.com/L-B-X/LBXStripper) - Lua Reascript for Reaper to create custom channel strips
* [Kong/opentracing-lua](https://github.com/Kong/opentracing-lua) - Opentracing Library for Lua
...
* [chicogamedev/Luven](https://github.com/chicogamedev/Luven) - Minimalist lighting engine for Löve2D
...
* [bungle/lua-resty-murmurhash2](https://github.com/bungle/lua-resty-murmurhash2) - LuaJIT MurmurHash 2 bindings to Nginx / OpenResty murmurhash2 implementation.
...
* [yourpalmark/mobile-detect.lua](https://github.com/yourpalmark/mobile-detect.lua) - Mobile device detection (phone, tablet, bot, mobile grade, os, versions, etc)
* [xiajunsongfan/lua-resty-thrift](https://github.com/xiajunsongfan/lua-resty-thrift) - lua-resty-thrift -- Lua thrift client driver for the ngx_lua based on the cosocket API
* [user-none/lua-hashings](https://github.com/user-none/lua-hashings) - Pure Lua hash library
...
* [p0pr0ck5/lua-ffi-libinjection](https://github.com/p0pr0ck5/lua-ffi-libinjection) - LuaJIT FFI bindings for libinjection
...
* [mtourne/ngx_lua_ssl](https://github.com/mtourne/ngx_lua_ssl) - How to use Nginx for SSL termination from any domain
...
* [CppCXY/luaClass](https://github.com/CppCXY/luaClass) - lua oop serilize datastructure
* [benwebber/lua-haproxy](https://github.com/benwebber/lua-haproxy) - Lua client and embedded HTTP API for HAProxy
...
* [not-kennethreitz/super-sphere](https://github.com/not-kennethreitz/super-sphere) - A minimal action game by Kenneth Reitz.
...
* [CandyMi/core_framework](https://github.com/CandyMi/core_framework) - 一个基于libev的轻量级lua网络开发框架 —— 也许这就是你想要的美.
