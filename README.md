...
* [kurapica/PLoop](https://github.com/kurapica/PLoop) - Prototype Lua object-oriented program system and frameworks. https://discord.gg/6hD4sdUtgp
...
* [EsreverWoW/ShestakUI_Classic](https://github.com/EsreverWoW/ShestakUI_Classic) - ShestakUI for WoW Classic (1.13.6) and Burning Crusade Classic (2.5.1)
...
* [Solor/FreeUI](https://github.com/Solor/FreeUI) - A user interface replacement for World of Warcraft, minimalistic aesthetic and practical.
* [HDoujinDownloader/HDoujin-Downloader](https://github.com/HDoujinDownloader/HDoujin-Downloader) - A manga and dōjinshi download manager.
...
* [RishabhRD/popfix](https://github.com/RishabhRD/popfix) - Neovim lua API for highly extensible quickfix window
...
* [SafeteeWoW/LibDeflate](https://github.com/SafeteeWoW/LibDeflate) - Pure Lua compressor and decompressor with high compression ratio using DEFLATE/zlib format.
...
* [AlexanderMisel/mwtest](https://github.com/AlexanderMisel/mwtest) - Building a MediaWiki/QQ bot in Lua
...
* [oneinstack/ngx_lua_waf](https://github.com/oneinstack/ngx_lua_waf) - ngx_lua_waf是一个基于lua-nginx-module的web应用防火墙
...
* [Luagram/LuagramProject](https://github.com/Luagram/LuagramProject) - 🦠 Telegram tdlib Client Library for lua
* [Grouflon/3rd_training_lua](https://github.com/Grouflon/3rd_training_lua) - Training mode for Street Fighter III: Third Strike, on FBA-RR emulator
...
* [numToStr/Navigator.nvim](https://github.com/numToStr/Navigator.nvim) - :sparkles: Smoothly navigate between splits and panes :sparkles:
...
* [benbusby/earthbound-themes](https://github.com/benbusby/earthbound-themes) - A set of unique color themes for Vim, VSCode, Atom, and Sublime
* [kennethreitz42/super-sphere](https://github.com/kennethreitz42/super-sphere) - A minimal action game by Kenneth Reitz.
...
* [Billiam/promise.lua](https://github.com/Billiam/promise.lua) - Promises/A+ 1.1 implementation in Lua
...
* [sile-typesetter/cassowary.lua](https://github.com/sile-typesetter/cassowary.lua) - A Lua port of the cassowary constraint solver engine
...
* [3scale/lua-resty-url](https://github.com/3scale/lua-resty-url) - OpenResty library for parsing URI
...
* [Quenty/luacheck-roblox](https://github.com/Quenty/luacheck-roblox) - Luacheck specifications for Roblox Lua
* [PlayFab/LuaSdk](https://github.com/PlayFab/LuaSdk) - PlayFab Lua SDK for LuaDist command-line, Defold, and more
* [CandyMi/core_framework](https://github.com/CandyMi/core_framework) - A lua high-performance web network development framework.
* [api7/lua-resty-etcd](https://github.com/api7/lua-resty-etcd) - Nonblocking Lua etcd driver library for OpenResty
* [kennethreitz-archive/super-sphere](https://github.com/kennethreitz-archive/super-sphere) - A minimal action game by Kenneth Reitz.
* [Xuyuanp/vimrc](https://github.com/Xuyuanp/vimrc) - My vim config
* [tesselode/nata](https://github.com/tesselode/nata) - Entity management for Lua.
...
* [nvim-lua/telescope.nvim](https://github.com/nvim-lua/telescope.nvim) - Find, Filter, Preview, Pick. All lua, all the time.
...
* [Starystars67/BeamNG-MP](https://github.com/Starystars67/BeamNG-MP) - A LUA implementation at attempting to bring local network multiplayer to BeamNG.drive
...
* [alpinelinux/awall](https://github.com/alpinelinux/awall) - [MIRROR] Alpine firewall configuration tool
...
* [Roblox/rojo](https://github.com/Roblox/rojo) - Rojo is a tool designed to enable Roblox developers to use professional-grade software engineering tools.
